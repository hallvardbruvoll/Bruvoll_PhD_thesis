...
-   Hierarchy @pumain2006 (hierarchy in natural and social sciences), @strauss2022 (dominance hierarchies/pecking order), @redhead2022 (social hierarchies humans)

Wolves:

@cafazzo2016, @packard2003: linear hierarchy and leadership among wolves.

@rodríguez2017: wolf "hierarchy", even when illustrated as pyramidal, is really linear (me).

In @muro2011: simulating wolf-pack hunting strategies without hierarchy

@mech1999: "linear dominance hierarchy" model doesn't fit well with most wolf packs in the wild, consisting of a single breeding couple and their offspring.

Branching, multi-level social hierarchies among animals: hamadryas baboons @schreier2009. Eusocial insects (ants, wasps...) @shimoji2022
...
-   Social complexity @daems2021 NA
