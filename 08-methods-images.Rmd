...
![Fractal dimension and mean lacunarity of the same image with variable degrees of added random spatial noise. See text for details. Number labels represent iteration, in this case steps of random walk performed independently for each point, and images are selected to prevent overlaps](Results/fig08_noise_im.pdf){#fig:08-noise-im alt="Different degrees of random spatial noise"}
...
![Clustering, size distribution and noise, compared to density](Results/fig08_all_im.pdf){#fig08-all-im}
