...
\hypertarget{testing-for-power-laws-resulting-from-data-aggregation}{%
\section{Testing for power laws resulting from data aggregation}\label{testing-for-power-laws-resulting-from-data-aggregation}}
...
Random number generation and iterated additive sequences, with K-S testing and model selection at each stage. Report when the distributions become power laws.
...
\caption{fdsasdfask}\label{fig:05-multi-ln}
\end{figure}
...
\caption{fdsasdfklkjlkøj}\label{fig:05-multi-ln-box}
\end{figure}
...
\hypertarget{summary-of-methodological-procedure}{%
\section{Summary of methodological procedure}\label{summary-of-methodological-procedure}}
