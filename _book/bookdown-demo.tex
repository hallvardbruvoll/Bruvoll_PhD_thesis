...
\hypertarget{effects-from-image-size-and-element-count}{%
\section{Effects from image size and element count}\label{effects-from-image-size-and-element-count}}
...
{\centering \includegraphics[width=0.9\linewidth]{bookdown-demo_files/figure-latex/08-im-size-1} 

}

\caption{Different image sizes}\label{fig:08-im-size}
\end{figure}
...
\begin{figure}
\hypertarget{fig:08-size-im}{%
\centering
\includegraphics{Results/fig08_size_im.pdf}
\caption{Selection of the different tested image sizes}\label{fig:08-size-im}
}
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{bookdown-demo_files/figure-latex/08-N-1} 

}

\caption{Element count (N).}\label{fig:08-N}
\end{figure}
...
\caption{Caption}\label{fig:08-N-im}
}
\end{figure}
