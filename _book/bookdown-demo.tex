...
\item
  Biologically defined thresholds to group size? Dunbar's number and controversies, Dunbar (2023), B. West et al. (2023) (add published papers). Scalar stress G. A. Johnson (1982), Alberti (2014), Zhou et al. (2005), M. S. Bandy (2004), M. Bandy (2008). Also Carneiro (1986), Dubreuil (2010), Drennan and Peterson (2008) (link from sedentarisation, neolithic demographic transition, to centralised communities and social complexity)
\item
...
Refs. house societies {[}Joyce and Gillespie (2000), Bnf; Beck (2007); Kuijt (2018); Lévi-Strauss (1982a); Bickle et al 2016 (reload in Zotero){]}.
