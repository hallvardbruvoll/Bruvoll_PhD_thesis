...
This simple form is called the \emph{standard} exponential distribution, and in most practical applications there will also be a \emph{rate} parameter \(\lambda\) (\emph{lambda}), so that the density function becomes \[p(x) = \lambda e^{-\lambda x}.\]
...
\hypertarget{log-normal-distributions-and-the-yule-process}{%
\subsection{Log-normal distributions and the Yule process}\label{log-normal-distributions-and-the-yule-process}}
