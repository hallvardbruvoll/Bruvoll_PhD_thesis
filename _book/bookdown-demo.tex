...
\SpecialStringTok{P(x) = (}\SpecialCharTok{\textbackslash{}frac}\SpecialStringTok{\{x\}\{x\_\{min\}\})\^{}\{{-}}\SpecialCharTok{\textbackslash{}alpha}\SpecialStringTok{+1\}}
\SpecialStringTok{(}\SpecialCharTok{\textbackslash{}\#}\SpecialStringTok{eq:pareto)}
