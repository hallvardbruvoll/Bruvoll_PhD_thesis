...
{\centering \includegraphics[width=0.7\linewidth]{bookdown-demo_files/figure-latex/04-PDF-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{bookdown-demo_files/figure-latex/04-cCDF-1} 
...
{\centering \includegraphics[width=0.7\linewidth]{bookdown-demo_files/figure-latex/04-still-normal-1} 
...
\begin{itemize}
\item
  Notes on terminology: Power law, Pareto (``80-20 rule'') and Zipf (rank-size rule), Newman (2005), pp.~327 and 350. Lack of consensus on notation, also for scaling parameter. Difference between PDF and CDF, continuous and discrete.
\item
  Upper and lower bounds. Other more complex models: stretched exponential, power law with exponential cutoff, parabolic fractal. Combination log-normal + exponential (i.e.~normal + exponential + exponential) (Reed 2001; Reed and Hughes 2002)
\item
...
\leavevmode\vadjust pre{\hypertarget{ref-ben-yosef2019}{}}%
Ben-Yosef, Erez, Brady Liss, Omri A. Yagel, Ofir Tirosh, Mohammad Najjar, and Thomas E. Levy. 2019. {``Ancient Technology and Punctuated Change: {Detecting} the Emergence of the {Edomite Kingdom} in the {Southern Levant}.''} \emph{PLOS ONE} 14(9):e0221967. doi: \href{https://doi.org/10.1371/journal.pone.0221967}{10.1371/journal.pone.0221967}.
...
\leavevmode\vadjust pre{\hypertarget{ref-dauphinuxe92011}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-kolodny2015}{}}%
Kolodny, Oren, Nicole Creanza, and Marcus W. Feldman. 2015. {``Evolution in Leaps: {The} Punctuated Accumulation and Loss of Cultural Innovations.''} \emph{Proceedings of the National Academy of Sciences} 112(49):E6762--69. doi: \href{https://doi.org/10.1073/pnas.1520492112}{10.1073/pnas.1520492112}.
...
\leavevmode\vadjust pre{\hypertarget{ref-reed2001}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-reed2002}{}}%
