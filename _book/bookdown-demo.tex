...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{load}\NormalTok{(}\StringTok{"Results/fig05\_type\_tail.RData"}\NormalTok{)}
\NormalTok{fig05\_type\_tail}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{bookdown-demo_files/figure-latex/next-1} 

}

\caption{caption}\label{fig:next}
\end{figure}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{load}\NormalTok{(}\StringTok{"Results/fig05\_synth\_pl.RData"}\NormalTok{)}
\NormalTok{fig05\_synth\_pl}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{bookdown-demo_files/figure-latex/next2-1} 

}

\caption{caption here}\label{fig:next2}
\end{figure}
\FloatBarrier
