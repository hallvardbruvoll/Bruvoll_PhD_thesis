...
\begin{itemize}
\item
  Notes on terminology: Power law, Pareto (``80-20 rule'') and Zipf (rank-size rule), Newman (2005), pp.~327 and 350. Lack of consensus on notation, also for scaling parameter.
\item
