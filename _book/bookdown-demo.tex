...
\caption{Fractal dimension and mean lacunarity of the same image with variable degrees of added random spatial noise. See text for details. Number labels represent iteration, in this case steps of random walk performed independently for each point, and images are selected to prevent overlaps}\label{fig:08-noise-im}
}
\end{figure}
...
Calculations of fractal dimension and lacunarity on synthetically generated test images provide useful clarifications on how these measures respond to changes in some crucial variables. Firstly
...
\begin{figure}
\hypertarget{fig08-all-im}{%
\centering
\includegraphics{Results/fig08_all_im.pdf}
\caption{Clustering, size distribution and noise, compared to density}\label{fig08-all-im}
}
\end{figure}

And then all and whole range.
